...
@pytest.mark.parametrize("data, expected_state, expected_result", [([{"id": 939719570, "state": "CANCELED", "date": "2018-06-30T02:08:58.425572"},
...
@pytest.mark.parametrize("date_1, order, expected", [([{"id": 41428829, "state": "EXECUTED", "date": "2019-07-03T18:35:29.512364"},
