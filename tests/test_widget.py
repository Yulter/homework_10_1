...
@pytest.mark.parametrize(
    "some_number, some_correct_number",
    [("Maestro 7000792289606361", "Maestro 7000 79** **** 6361"), ("Счет 35383033474447895560", "Счет **5560")],
)
...
@pytest.mark.parametrize(
    ...
    [("2024-03-11T02:26:18.671407", "11.03.2024"), ("2025-03-11T02:26:18.671407", "11.03.2025")],
)
